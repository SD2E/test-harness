...
class KerasClassification(ClassificationModel):
    def __init__(self, model, model_description, epochs=25, batch_size=1000, class_weight=None, verbose=0):
        super(KerasClassification, self).__init__(model, model_description)
        self.epochs = epochs
