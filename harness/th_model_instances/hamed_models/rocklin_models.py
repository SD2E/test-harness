...
def rocklins_logistic_classifier(penalty='l1', C=0.1, n_join=-1,solver='liblinear'):
    rocklins_logistic_model = LogisticRegression(penalty=penalty, C=C, n_jobs=n_join,solver=solver)
