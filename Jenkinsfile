...
pipeline {
    ...
    environment {
        ...
        GITLAB_API_AUTH_TOKEN = credentials('83b032c2-f3f4-43a9-a967-d73e411543a7')
    ...
    stages {
        ...
        stage('Run perovskite test harness') {
            ...
            steps {
                ...
                sh 'pip3 install -r requirements-app.txt --user'
                sh "python3 ${WORKSPACE}/scripts/perovskite_test_harness.py $GITLAB_API_AUTH_TOKEN"
