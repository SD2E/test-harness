...
pipeline {
    ...
    environment {
        ...
        GITLAB_API_AUTH_TOKEN = credentials('nick-test-gitlab-api-key')
    ...
    stages {
        ...
        stage('Run perovskite test harness') {
            ...
            steps {
                ...
                sh "python ${WORKSPACE}/scripts_for_automation/perovskite_test_harness.py --gitlab_auth $GITLAB_API_AUTH_TOKEN"
