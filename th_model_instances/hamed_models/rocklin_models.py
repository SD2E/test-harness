...
def rocklins_linear_regression():
    ...
    th_model = SklearnRegression(model=rocklins_linear_model, model_description='Rocklin LinReg: Default sklearn linear regression')
    return th_model
...
def rocklins_gradboost_regression():
    ...
    th_model = SklearnRegression(model=rocklins_gradboost_model,
