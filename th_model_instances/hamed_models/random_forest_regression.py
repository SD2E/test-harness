...
def rfr_features(bootstrap=False, min_samples_leaf=1, n_estimators=689, min_samples_split=2,
    ...
    mr_rfr = RFRegression(model=rfr,
                          model_description="Random Forest Regressor: bootstrap={0}, min_samples_leaf={1}, n_estimators={2}, min_samples_split={3}, max_features={4}, max_depth={5}, n_jobs={6}".format(
