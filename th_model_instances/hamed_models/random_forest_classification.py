...
def random_forest_classification(n_estimators=361, max_features='auto', criterion='entropy', min_samples_leaf=13,
    ...
    rfc = RandomForestClassifier(n_estimators=n_estimators, max_features=max_features, criterion=criterion, min_samples_leaf=min_samples_leaf,
    ...
    mr_rfc = SklearnClassification(model=rfc,
                                   model_description="Random Forest: n_estimators={0}, max_features={1}, criterion={2}, min_samples_leaf={3}, n_jobs={4}".format(n_estimators,max_features,criterion,min_samples_leaf,n_jobs))
    return mr_rfc